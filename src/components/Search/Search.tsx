        ...
        <div className="search-buttons">
          ...
          {onFavoritesClick && (
            <button
              ...
              title="スワイプで探す"
            >
              {/* 重なったカード（スワイプデッキ）を表すアイコン */}
              <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#4B4B4B" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                <rect x="4" y="6" width="11" height="14" rx="2" transform="rotate(-10 9.5 13)"></rect>
                <rect x="9" y="4" width="11" height="14" rx="2" fill="#fff"></rect>
              </svg>
            </button>
          )}
        </div>
